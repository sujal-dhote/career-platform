...
import { Building2, Briefcase, GraduationCap, Users, LogOut, FileText } from 'lucide-react'
  ...
  if (selectedAgent) {
    return (
      <div className="min-h-screen bg-slate-900">
        <ChatInterface agentType={selectedAgent} onBack={() => setSelectedAgent(null)} />
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-orange-900">
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">Career Platform</h1>
            <p className="text-slate-300">Welcome, {session.user?.name || session.user?.email}!</p>
          </div>
          <button
